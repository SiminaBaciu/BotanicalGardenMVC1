...
public class PlantDAO extends AbstractDAO<Plant> {
    ...
    public void sqlToCSV() {
        String filename = "C:\\Facultate\\ThirdYear\\Second_Sem\\SD\\Assignment2\\databaseToCSV.csv";
        try {
    ...
    public void sqlToTXT() {
        String filename = "C:\\Facultate\\ThirdYear\\Second_Sem\\SD\\Assignment2\\databaseToTXT.txt";
        try {
            FileWriter fw = new FileWriter(filename);
            // Class.forName("com.mysql.jdbc.Driver");
            Connection conn = ConnectionFactory.getConnection();
    ...
    public void sqlToXML() throws SQLException, IOException, TransformerException, ParserConfigurationException {
        ...
        StreamResult result = new StreamResult(new File("C:\\Facultate\\ThirdYear\\Second_Sem\\SD\\Assignment2\\databaseToXML.xml"));
    ...
    public void sqlToJSON() {
        try {
            ...
            FileWriter file = new FileWriter("C:\\Facultate\\ThirdYear\\Second_Sem\\SD\\Assignment2\\databaseToJSON.json");
